...
<div class="site-rl-tournament-overview">
    ...
    <?php if (count($runningTurnier) > 0 || count($preRunningTurnier) > 0): ?>
        <table class="turnierStatus table table-bordered table-striped table-hover">
            <thead>
            <tr class="bg-success">
                <th class="namedHeader" colspan="3"><?= \app\modules\mariokartdeluxe\Module::t('overview', 'runningtournaments', $siteLanguage->locale) ?><span
            ...
            <tr class="bg-success">
                ...
                <th><?= \app\modules\mariokartdeluxe\Module::t('overview', 'startingdate', $siteLanguage->locale) ?></th>
                <th><?= \app\modules\mariokartdeluxe\Module::t('overview', 'status', $siteLanguage->locale) ?></th>
            </tr>
            </thead>
            <tbody>
            ...
            <?php foreach ($preRunningTurnier as $tournament): ?>
                <tr>
                    <td><?= '[' . $tournament->getMode()->one()->getName() . '] ' . Html::a($tournament->showRealTournamentName(), ['/mariokartdeluxe/tournament-details', 'id' => $tournament->getId()]) ?>
                        <span class="badge"><?= count($tournament->getParticipants()->all()); ?></span></td>
                    <td><?= $tournament->getDtStartingTime(); ?></td>
                    <td><?= \app\modules\mariokartdeluxe\Module::t('overview', 'preparing', $siteLanguage->locale) ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
    ...
    <?php if (count($checkInTurnier) > 0 || count($preCheckInTurnier) > 0): ?>
        <table class="turnierStatus table table-bordered table-striped table-hover">
            ...
            <tr class="bg-success">
                <th><?= \app\modules\mariokartdeluxe\Module::t('overview', 'tournamentname', $siteLanguage->locale) ?></th>
                <th><?= \app\modules\mariokartdeluxe\Module::t('overview', 'checkindate', $siteLanguage->locale) ?></th>
                <th><?= \app\modules\mariokartdeluxe\Module::t('overview', 'checkinduration', $siteLanguage->locale) ?></th>
                <th><?= \app\modules\mariokartdeluxe\Module::t('overview', 'checkin', $siteLanguage->locale) ?></th>
            </tr>
            </thead>
            <tbody>
            ...
            <?php foreach ($preCheckInTurnier as $tournament): ?>
                ...
                ?>
                <tr>
                    <td><?= '[' . $tournament->getMode()->one()->getName() . '] ' . Html::a($tournament->showRealTournamentName(), ['/mariokartdeluxe/tournament-details', 'id' => $tournament->getId()]); ?> <span
    ...
    <?php if (count($registerTurnier) > 0): ?>
        <table class="turnierStatus table table-bordered table-striped table-hover">
            <thead>
            <tr class="bg-info">
                <th class="namedHeader" colspan="4"><?= \app\modules\mariokartdeluxe\Module::t('overview', 'tournamentregistration', $siteLanguage->locale) ?><span
            ...
            <tr class="bg-info">
                ...
                <th><?= \app\modules\mariokartdeluxe\Module::t('overview', 'startingdate', $siteLanguage->locale) ?></th>
                <th><?= \app\modules\mariokartdeluxe\Module::t('overview', 'checkinduration', $siteLanguage->locale) ?></th>
                <th><?= \app\modules\mariokartdeluxe\Module::t('overview', 'chooseyourteam', $siteLanguage->locale) ?></th>
            </tr>
            </thead>
            <tbody>
    ...
    <?php if (count($plannedTurnier) > 0): ?>
        <table class="turnierStatus foldable table table-bordered table-striped table-hover">
            <thead>
            <tr class="bg-warning">
                <th class="namedHeader" colspan="2"><?= \app\modules\mariokartdeluxe\Module::t('overview', 'tournamentplaning', $siteLanguage->locale) ?><span
            ...
            <?php foreach ($plannedTurnier as $tournament): ?>
                <tr class="fold">
                    <td><?= '[' . $tournament->getMode()->one()->getName() . '] ' . Html::a($tournament->showRealTournamentName(), ['/mariokartdeluxe/tournament-details', 'id' => $tournament->getId()]) ?></td>
                    <td><?= $tournament->getDtStartingTime(); ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
    ...
    <?php if (count($archivTurnier) > 0): ?>
        <table class="turnierStatus foldable table table-bordered table-striped table-hover">
            <thead>
            <tr class="bg-warning">
                <th class="namedHeader" colspan="2"><?= \app\modules\mariokartdeluxe\Module::t('overview', 'tournamentachive', $siteLanguage->locale) ?><span
