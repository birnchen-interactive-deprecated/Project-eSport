...
<div class="site-account">
    ...
    <div class="col-lg-6 playerPanel">
        ...
        <div class="userBody">
            ...
            <div class="clearfix">
                <div class="col-lg-12 teamHeader"><?= \app\modules\user\Module::t('account', 'clans', $siteLanguage->locale) ?></div>
            </div>
            <div class="teamBody clearfix">
                <div class="col-xs-12 col-sm-6">
                    <div class="mainTeam">
                        <?= \app\modules\user\Module::t('account', 'clan', $siteLanguage->locale) ?>
                        <?php if ($userInfo['isMySelfe']) : ?>
                        <?php
                            echo Html::a('',
                                [
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="mainTeam"><?= \app\modules\user\Module::t('account', 'team', $siteLanguage->locale) ?></div>
