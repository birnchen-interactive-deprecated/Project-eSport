...
<footer class="footer">
    <div class="container">
        ...
        <div class="col-sm-3 col-lg-3 right_side">
            <span><?= Html::a(Yii::$app->HelperClass->checkImage('/images/socialMedia/', 'Twitter_Logo_Blue') . 'webp', 'https://twitter.com/esport_project', ['target' => '_blank', 'rel' =>'noopener', 'aria-label' => 'Follow us on twitter', 'label' => 'twitter']); ?></span>
